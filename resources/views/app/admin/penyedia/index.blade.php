...
@section('content')
    <div class="page-header">
        <div>
            ...
            <h1>Penyedia</h1>
            <p>Kelola data penyedia dari Kementrian atau Perusahaan Milik Negara</p>
        </div>
        <button class="btn-primary-custom" onclick="info()" type="button">
            <i class="bi bi-plus-lg"></i> Tambah Penyedia
        </button>
    </div>
...
@push('scripts')
    <script>
        ...
        let selected_page = 1, _token = '{{ csrf_token() }}', base_url = '{{ route('penyedia.index') }}', params_url = '{{ $params ?? '' }}';
