...
@section('content')
    <div class="page-header">
        <div>
            ...
            <h1>Indikator</h1>
            <p>Kelola kategori indikator perbaikan wilayah terdampak bencana</p>
        </div>
    ...
    <div class="panel">
        <div class="panel-header">
            <h5><i class="bi bi-table"></i> Data Indikator</h5>
...
@push('scripts')
    <script>
        ...
        let selected_page = 1, _token = '{{ csrf_token() }}', base_url = '{{ route('indikator.index') }}', params_url = '{{ $params ?? '' }}';
        ...
        let init_form = (id = '') => {
            ...
            $form_info.submit((e) => {
                ...
                $.ajax({
                    ...
                    contentType: false,
                    success: () => {
                        if (id === '') showToast('Indikator berhasil ditambahkan', 'success');
                        else showToast('Indikator berhasil diubah', 'success');
                        init()
                    },
                }).fail((xhr) => {
