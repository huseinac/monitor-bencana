...
@section('title')
    Pembayaran Pekerjaan - {{ $paket_pekerjaan->nama }} -
@endsection
...
@push('scripts')
    <script>
        ...
        let selected_page = 1, _token = '{{ csrf_token() }}', base_url = '{{ route('paket_pekerjaan.pembayaran_pekerjaan.index', $paket_pekerjaan->id) }}', params_url = '{{ $params ?? '' }}';
