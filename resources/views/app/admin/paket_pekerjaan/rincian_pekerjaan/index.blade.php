...
@section('title')
    Rincian Pekerjaan - {{ $paket_pekerjaan->nama }} -
@endsection
...
@push('scripts')
    <script>
        ...
        let selected_page = 1, _token = '{{ csrf_token() }}', base_url = '{{ route('paket_pekerjaan.rincian_pekerjaan.index', $paket_pekerjaan->id) }}', params_url = '{{ $params ?? '' }}';
