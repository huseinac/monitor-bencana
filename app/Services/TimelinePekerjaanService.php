...
use App\Models\TimelinePekerjaan;

class TimelinePekerjaanService extends IoService
{
    public function __construct()
    {
        $this->model = new TimelinePekerjaan();
        $this->sort_by = ['id' => 'asc'];
    ...
    {
        $params = $this->cleanNumber($params, ['target']);
        return $this->cleanDate($params, ['tanggal_awal', 'tanggal_akhir']);
    }
